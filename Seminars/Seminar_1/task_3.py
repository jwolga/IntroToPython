...
с 1 (при этом иногда вагоны нумеруются от «головы» поезда, 
...
Output: 6
'''
i = int(input('Введите порядковый номер вагона '))
j = int(input('Укажите номер вагона '))
if i == j:
    print('Недостаточно инф')
else:
