...
if (int(ticket[0]) + int(ticket[1]) + int(ticket[2])) == (int(ticket[3]) + int(ticket[4]) + int(ticket[5])):
    print(f'{int(ticket[0]) + int(ticket[1]) + int(ticket[2])} равно {int(ticket[3]) + int(ticket[4]) + int(ticket[5])}')
    print('YES')
else:
    print(f'{int(ticket[0]) + int(ticket[1]) + int(ticket[2])} неравно {int(ticket[3]) + int(ticket[4]) + int(ticket[5])}')
    print('NO')